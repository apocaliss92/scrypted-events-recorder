...
import { VideoClips, Camera, ScryptedDevice, ScryptedDeviceBase, Settings, VideoCamera, ObjectDetector } from "@scrypted/sdk";
import fs from 'fs';
...
export type DeviceType = VideoClips & VideoCamera & Camera & Settings & ScryptedDeviceBase & ScryptedDevice & ObjectDetector;
